...
class HSICityV2Dataset(CustomDataset):
    """HGICityV2 dataset
    """
    ...
    def __init__(self,
                 ...
                 addition='img',
                 **kwargs):
        super(HSICityV2Dataset, self).__init__(
    ...
    def evaluate(self,
        ...
        if len(metrics) > 0:
            eval_results.update(
                super(HSICityV2Dataset, self).evaluate(results, metrics,
                                                       logger))
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
                         split):
        img_infos = []
        for img in mmcv.scandir(img_dir, '.pt'):
            name = img[:-3]
            img_info = {
                'name': name,
    ...
    def get_hsi_info(self, idx):
        return self.img_infos[idx]['hsiname']
